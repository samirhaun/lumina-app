...
<?php $__env->startSection('title', 'Custos Diversos'); ?>
    ...
    <script>
        $(function() {
            ...
            function updateMiscCategoriesDropdown(selectedValue = null) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.misc-categories.list')); ?>",
                    type: 'GET',
            ...
            var miscCategoriesTable = $('#miscCategoriesTable').DataTable({
                processing: true,
                ajax: "<?php echo e(route('admin.misc-categories.data')); ?>",
                columns: [{
                        data: 'id'
                    },
                    {
            ...
            var miscItemsTable = $('#miscItemsTable').DataTable({
                processing: true,
                ajax: "<?php echo e(route('admin.misc-items.data')); ?>",
                columns: [{
                        data: 'id'
                    },
                    {
            ...
            $('[data-bs-target="#miscCategoryModal"]').on('click', function() {
                ...
                $('#miscCategoryForm').data('method', 'POST').data('url',
                    '<?php echo e(route('admin.misc-categories.store')); ?>');
            });
            ...
            $('#miscCategoriesTable tbody').on('click', '.edit-category-btn', function() {
                ...
                $('#miscCategoryForm').data('method', 'PUT').data('url',
                    `<?php echo e(url('admin/misc-categories')); ?>/${data.id}`);
            ...
            $('#miscCategoriesTable tbody').on('click', '.delete-category-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(url('admin/misc-categories')); ?>/${data.id}`,
                            type: 'DELETE',
                            success: function(response) {
            ...
            $('[data-bs-target="#miscItemModal"]').on('click', function() {
                ...
                $('#miscItemForm').data('method', 'POST').data('url',
                    '<?php echo e(route('admin.misc-items.store')); ?>');
            });
            ...
            $('#miscItemsTable tbody').on('click', '.edit-item-btn', function() {
                ...
                $('#miscItemForm').data('method', 'PUT').data('url',
                    `<?php echo e(url('admin/misc-items')); ?>/${data.id}`);
            ...
            $('#miscItemsTable tbody').on('click', '.delete-item-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(url('admin/misc-items')); ?>/${data.id}`,
                            type: 'DELETE',
                            success: function(response) {
                                Swal.fire('Excluído!', response.success, 'success');
                                miscItemsTable.ajax.reload(null, false);
...
<?php echo $__env->make('admin::layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Samir\Desktop\lumina-app\Modules/Admin\resources/views/misc/index.blade.php ENDPATH**/ ?>