...
<div id="purchasesContent">
  ...
  <div class="card card-terracotta card-tabs">
    <div class="card-header d-flex justify-content-between align-items-center">
      <a href="<?php echo e(route('admin.purchases.create')); ?>" class="btn btn-success">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(function() {
            ...
            ?>
            let unexpectedItemsData = <?php echo json_encode($jsDataForReceiveModal, 15, 512) ?>;
            const dtLanguage = {
            ...
            const purchasesTable = $('#purchasesTable').DataTable({
                ...
                ajax: "<?php echo e(route('admin.purchases.data')); ?>",
                order: [
                    [1, 'desc']
                ],
                columns: [{
            ...
            $('#purchasesTable tbody').on('click', 'td.dt-control', function(e) {
                ...
                if (row.child.isShown()) {
                    ...
                    $.get(`<?php echo e(url('admin/purchases')); ?>/${row.data().id}/items`)
                        .done(response => {
            ...
            $('#purchasesTable tbody').on('click', '.details-btn', function() {
                ...
                $.get(`<?php echo e(url('admin/purchases')); ?>/${purchaseId}/details`).done(data => {
                    ...
                    $('#updatePaymentStatusForm').attr('action',
                        `<?php echo e(url('admin/purchases')); ?>/${purchase.id}/update-payment-status`);
                ...
                Swal.fire({
                    ...
                    .then(result => {
                        if (result.isConfirmed) {
                            $.ajax({
                                url: `<?php echo e(url('admin/purchases')); ?>/${id}`,
                                type: 'DELETE'
                            }).done(response => {
            ...
            $('#receiveItemsForm').on('submit', function(e) {
                ...
                $.post(`<?php echo e(url('admin/purchases')); ?>/${$('#receiveItemsForm').data('purchase-id')}/receive`, {
                        items: itemsData
                    })
                    .done(response => {
...
<?php echo $__env->make('admin::layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Samir\Desktop\lumina-app\Modules/Admin\resources/views/purchases/index.blade.php ENDPATH**/ ?>