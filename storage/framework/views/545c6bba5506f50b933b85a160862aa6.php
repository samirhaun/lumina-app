                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="products-stock">
                        <ul class="nav nav-pills mb-3" id="product-type-tabs">
                            ...
                            <?php $__currentLoopData = $productTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" data-category="<?php echo e($type->name); ?>">
                    ...
                    <div class="tab-pane" id="misc-stock">
                        <ul class="nav nav-pills mb-3" id="misc-category-tabs">
                            ...
                            <?php $__currentLoopData = $miscCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" data-category="<?php echo e($category->name); ?>">
    ...
    <script>
        $(function() {
            ...
            const productStockTable = $('#productStockTable').DataTable({
                ...commonTableOptions,
                ajax: "<?php echo e(route('admin.stock.product-data')); ?>",
                columns: [{
                        data: 'name'
                    }, {
                        data: 'category'
            ...
            const miscStockTable = $('#miscStockTable').DataTable({
                ...commonTableOptions,
                ajax: "<?php echo e(route('admin.stock.misc-item-data')); ?>",
                columns: [{
                        data: 'name'
                    }, {
                        data: 'category'
            ...
            $('#editMinimumStockForm').on('submit', function(e) {
                ...
                $.post("<?php echo e(route('admin.stock.update-minimum')); ?>", data)
...
<?php echo $__env->make('admin::layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bruno\Documents\lumina-app\lumina-app\Modules/Admin\resources/views/stock/index.blade.php ENDPATH**/ ?>