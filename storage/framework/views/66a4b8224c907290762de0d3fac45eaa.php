    ...
    <script>
        $(function() {
            ...
            $('#typesTable tbody').on('click', '.edit-type-btn', function() {
                ...
                $('#typeForm').data('method', 'PUT').data('url', '<?php echo e(url('admin/product-types')); ?>/' + data
                    .id);
            ...
            $('[data-bs-target="#productModal"]').on('click', function() {
                ...
                $('#productForm').data('method', 'POST').data('url', '<?php echo e(route('admin.products.store')); ?>');
            });
...
<?php echo $__env->make('admin::layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Samir\Desktop\lumina-app\Modules/Admin\resources/views/products/index.blade.php ENDPATH**/ ?>