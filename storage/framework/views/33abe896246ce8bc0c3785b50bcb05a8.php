<?php $__env->startSection('title', 'Registrar Nova Venda'); ?>
                    ...
                    <div class="card-body">
                        <div class="row g-2 align-items-end">
                            <div class="col-md-4 form-group"><label>Categoria do Custo</label><select
                                    ...
                                    <?php $__currentLoopData = $miscCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        $(function() {
            ...
            $('#product_search').select2({
                ...
                ajax: {
                    url: "<?php echo e(route('admin.sales.search-products')); ?>",
                    dataType: 'json',
                    delay: 250,
                    processResults: data => ({
            ...
            $('#miscCategorySelector').on('change', function() {
                ...
                if (!catId) return;
                $.get("<?php echo e(route('admin.sales.search-misc-items')); ?>", {
                    category_id: catId
                }).done(response => {
...
<?php echo $__env->make('admin::layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bruno\Documents\lumina-app\lumina-app\Modules/Admin\resources/views/sales/create.blade.php ENDPATH**/ ?>