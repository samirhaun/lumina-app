<?php $__env->startSection('title', 'Gerenciar Banners'); ?>
<?php $__env->startSection('header', 'Banners da Homepage'); ?>
    ...
    <div id="bannerCatalog">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('admin.hero-banners.create')); ?>" class="btn btn-success">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(function() {
            const baseUrl = "<?php echo e(url('admin/hero-banners')); ?>";
            const dataTableUrl = "<?php echo e(route('admin.hero-banners.data')); ?>";
...
<?php echo $__env->make('admin::layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bruno\Documents\lumina-app\lumina-app\Modules/Admin\resources/views/hero-banners/index.blade.php ENDPATH**/ ?>