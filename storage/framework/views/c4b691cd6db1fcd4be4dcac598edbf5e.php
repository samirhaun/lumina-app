...
<body>
    <div class="login-wrapper">
        ...
        <div class="login-left">
            <img src="<?php echo e(asset('images/lumina-logo.png')); ?>" alt="Logo Lúmina" class="logo-center">
        </div>

        <div class="login-right">
            <img src="<?php echo e(asset('images/logo-terracota.png')); ?>" alt="Logo Terracota" class="logo-terracotta-top">
                ...
                <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>">
                    ...
                    <div class="form-group">
                        <label for="username" class="form-label">Nome de Usuário</label> <input id="username"
                            name="username" type="text" class="form-input <?php $__errorArgs = ['username'];
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('username')); ?>" required> <?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\Users\Samir\Desktop\lumina-app\Modules/Admin\resources/views/auth/login.blade.php ENDPATH**/ ?>