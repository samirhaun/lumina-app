...
<?php $__env->startSection('title', 'Precificação de Produtos'); ?>
          ...
          <div class="col-md-4">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control global-price-input"
                     ...
                     value="<?php echo e(number_format($settings['global_default_misc_costs'] ?? 0, 2, ',', '.')); ?>">
            </div>
          </div>
          <div class="col-md-4">
            ...
            <div class="input-group">
              <input type="text" class="form-control global-price-input"
                     ...
                     value="<?php echo e(number_format($settings['global_profit_margin'] ?? 0, 2, ',', '.')); ?>">
            ...
            <script>
                $(function() {
                    ...
                    pricingTable = $('#pricingTable').DataTable({
                        processing: true,
                        ajax: "<?php echo e(route('admin.pricing.data')); ?>",
                        columns: [{
                                data: 'name'
                            },
                            {
                    ...
                    $('#globalSettingsForm').on('submit', function(e) {
                        e.preventDefault();
                        $.post("<?php echo e(route('admin.pricing.settings.update')); ?>", $(this).serialize())
                    ...
                    $('#pricingTable tbody').on('click', '.save-pricing-btn', function() {
                        ...
                        const url = `<?php echo e(url('admin/pricing')); ?>/${id}`;
                        const data = {
                            _method: 'POST',
...
<?php echo $__env->make('admin::layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Samir\Desktop\lumina-app\Modules/Admin\resources/views/pricing/index.blade.php ENDPATH**/ ?>