...
use Modules\Admin\Http\Controllers\HeroBannerController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::get('clients/{id}/sales', [Modules\Admin\Http\Controllers\ClientController::class, 'getSalesHistory'])->name('admin.clients.sales-history');
        ...
        // ROTAS PARA OS BANNERS DA HOMEPAGE
        Route::resource('hero-banners', HeroBannerController::class)->except(['show']);
        Route::get('hero-banners-data', [HeroBannerController::class, 'data'])->name('hero-banners.data');
