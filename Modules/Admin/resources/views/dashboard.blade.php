...
@section('content')
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-5 g-3 mb-3">
        {{-- Total em Vendas --}}
        <div class="col">
            <a href="{{ route('admin.sales.index') }}" class="small-box bg-success text-white d-block">
                <div class="inner">
        ...
        <div class="col">
            <a href="{{ route('admin.sales.index') }}" class="small-box bg-info text-white d-block">
                <div class="inner">
        ...
        {{-- Total em Saídas --}}
        <div class="col">
            <a href="{{ route('admin.purchases.index') }}" class="small-box bg-danger text-white d-block">
                <div class="inner">
        ...
        {{-- Estoque --}}
        <div class="col">
            <a href="{{ route('admin.stock.index') }}" class="small-box bg-warning text-dark d-block">
                <div class="inner">
                    <h3>Estoque</h3>
