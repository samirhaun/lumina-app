...
$(function () {
    ...
    $('[data-bs-target="#supplierModal"]').on('click', function() {
        ...
        $('#supplierForm').data('method', 'POST').data('url', '{{ route("admin.suppliers.store") }}');
    });
    ...
    $('#suppliersTable tbody').on('click', '.edit-btn', function() {
        ...
        $('#supplierForm').data('method', 'PUT').data('url', `{{ url("admin/suppliers") }}/${data.id}`);
    ...
    $('#suppliersTable tbody').on('click', '.delete-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `{{ url("admin/suppliers") }}/${data.id}`,
                    type: 'DELETE',
                    success: function(response) {
