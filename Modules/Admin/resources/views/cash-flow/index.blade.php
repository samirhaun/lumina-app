...
@section('header', 'Relatório de Fluxo de Caixa')
...
{{-- SEÇÃO DE RESULTADOS (COMEÇA ESCONDIDA) --}}
...
@push('scripts')
{{-- Scripts para os botões de exportação do DataTables --}}
...
$(function () {
    ...
    $('#cashFlowForm').on('submit', function(e) {
        ...
        const url = `{{ route('admin.cash-flow.report') }}?start_date=${startDate}&end_date=${endDate}`;
